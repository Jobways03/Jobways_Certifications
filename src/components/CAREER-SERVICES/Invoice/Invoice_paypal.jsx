  ...
  return (
    <div ref={ref}>
      <div className="pdf-invoice">
        <img src="./images/job_pay.png" alt="...Loading" className="i3" />
        <p className="eadd1-p">Jobways Point LLP</p>
        ...
        <p className="eadd4">Email: accounts@jobways.com</p>
        ...
        <p className="mac1-p2">Jobways Point LLP</p>

        <p className="last1">JOBWAYS POINT LLP</p>
