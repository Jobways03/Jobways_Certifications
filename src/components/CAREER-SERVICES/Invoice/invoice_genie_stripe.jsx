...
const ComponentToPrint = React.forwardRef(({ showExtras }, ref) => {
  ...
  const tota =
    parseFloat(Global.formData.subTotal) +
    parseFloat(Global.formData.internetFee) +
    parseFloat(Global.formData.stripeFee);
  ...
  return (
    <div ref={ref}>
      <div className="pdf-invoice">
        ...
        <p className="tri">TAX RATE</p>
        <p className="taxi">TAX</p>
        <p className="ifi">Internet Fee</p>
        <p className="sfi">Paypal Fee</p>
        <div className="sta">{Global.formData.subTotal}.00 USD</div>
        <div className="tria">NA</div>
        <div className="taxia">NA</div>
        <div className="ifia">{Global.formData.internetFee} USD</div>
        <div className="sfia">{Global.formData.stripeFee} USD</div>
        <p className="totii2">TOTAL</p>
        <div className="toti2">{total} USD</div>
        ...
        <p className="mac">Make all checks payable to</p>
        <p className="mac12">GenieLamp Private Limited</p>
        <p className="tyf">Thank You for Your Business!</p>
        <p className="last1">GenieLamp Private Limited</p>
        <p className="last2">+91 63004 82790</p>
...
const Invoice_GenieLamp_Stripe = () => {
...
export default Invoice_GenieLamp_Stripe;
