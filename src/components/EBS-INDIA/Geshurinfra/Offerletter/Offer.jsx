  ...
  return (
    <div ref={ref}>
      <div className="pdf-offer">
        ...
        <p className="gio80">
          Any customer or associate to move his existing business with Geshur
          Infra PVT LTD to a third party or to terminate their business
          relationship with Geshur Infra PVT LTD
        </p>
        ...
        <p className="gio103">
          We welcome you to <span className="bol">Geshur Infra PVT LTD</span>{" "}
          Family and look forward to many years of mutually rewarding
        ...
        <p className="gio117s">SALARY STRUCTURE</p>
...
export default Geshurinfraoffer;
