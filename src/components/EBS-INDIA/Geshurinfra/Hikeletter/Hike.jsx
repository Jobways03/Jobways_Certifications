  ...
  return (
    <div ref={ref}>
      <div className="pdf-offer">
        ...
        <p className="hiker4c">
          that <span className="bold">Geshur Infra Private Limited</span> will
          be providing a hike on your current CTC.
        </p>
        ...
        <p className="hikers6c">
          ...
          <span className="bold">Geshur Infra Private Limited</span>, and we
        ...
        <img src="./images/bgrem.png" alt="ewded" className="gesstamps" />
