    ...
    <div ref={ref}>
      <div className="pdf-offer">
        ...
        <p className="let4">
          ...
          ” in
          <span className="bol" style={{ fontSize: "14px" }}>
            {" "}
            Genie Lamp Pvt Ltd.
          </span>{" "}
        ...
        <p className="let5">
          ...
          located at{" "}
          <span className="bol" style={{ fontSize: "15px" }}>
            Flat no: 7-140/1, E 5, Nagendra Nagar, Scientist Colony, Habsiguda,
        ...
        {/* <p className="con nu1">+91 63004 02669</p> */}
        ...
        <p className="let21">
          ...
          <span className="bol">GENIE LAMP PVT. LTD</span>. Hyderabad, India
        ...
        {/* <p className="con nu2">+91 63004 02669</p> */}
        ...
        <p className="let25">
          ...
          <span className="bol">GENIE LAMP PVT. LTD</span>. is the intellectual
        ...
        {/* <p className="con nu3">+91 63004 02669</p> */}
        <div className="ds2"></div>
        <img
          ...
          style={{ height: "1130px" }}
        />
        <p className="let29" style={{ fontWeight: "600" }}>
          9. DOCUMENTS:
        </p>
        <p className="let30">
        ...
        {sessionStorage.getItem("offerStamp") === "with_stamp" && (
          <img src="./images/Geniestamp.png" alt="stamp" className="genstamp" />
        )}
        <p className="let39">
          <span className="bol" style={{ fontSize: "15px" }}>
            Shiva Kumar
        ...
        {/* <p className="con nu4">+91 63004 02669</p> */}
        <div className="ds2"></div>
      </div>
    </div>
  );
