...
const Paystubbox = () => {
  ...
  const cards = [
    { label: 'RAPID HIRING', onClick: () => handle('rapid') },
    { label: 'KACEE TECH', onClick: () => handle('kacee') },
    { label: 'JOBWAYS LLC', onClick: () => handle('jobways') },
  ];

  return (
    <div style={pageStyle}>
      <h1 style={titleStyle}>SELECT COMPANY - PAYSTUB</h1>
      <div style={gridStyle}>
