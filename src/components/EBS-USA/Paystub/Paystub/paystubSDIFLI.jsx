...
const ComponentToPrint = React.forwardRef((props, ref) => {
  ...
  const currenttotaltaxe =
    parseFloat(Global.form.medicareCurrent) +
      ...
      parseFloat(Global.form.SDICurrent) +
  ...
  return (
    <div ref={ref}>
      <div className="sdi-pdf-page">
        ...
        <p id="sdi-tax4-s">{Global.form.state} – SDI</p>
        <p id="sdi-tax4-1-s">- {Global.form.SDICurrent}</p>
        <p id="sdi-tax4-2-s">- {Global.form.sdiYTD}</p>

        <p id="sdi-tax4-s-f">{Global.form.state} – FLI</p>
        <p id="sdi-tax4-1-s-f">- {Global.form.FLICurrent}</p>
        <p id="sdi-tax4-2-s-f">- {Global.form.FLIYTD}</p>

        <div id="sdi-line4-f"></div>
        <p id="sdi-tax5-1-f">- {currenttotaltaxes}</p>
        <p id="sdi-tax5-2-f">- {YTDtotaltaxes}</p>
        <p id="sdi-tax6-f">Net Pay</p>
        <p id="sdi-tax6-1-f">
          {parseFloat(
        ...
        <p id="sdi-tax4s-s">{Global.form.state} – SDI</p>
        <p id="sdi-tax4-1s-s">- {Global.form.SDICurrent}</p>
        <p id="sdi-tax4-2s-s">- {Global.form.sdiYTD}</p>

        <p id="sdi-tax4s-s-f1">{Global.form.state} – FLI</p>
        <p id="sdi-tax4-1s-s-f1">- {Global.form.FLICurrent}</p>
        <p id="sdi-tax4-2s-s-f1">- {Global.form.FLIYTD}</p>

        <div id="sdi-line4s-f"></div>
        <p id="sdi-tax5-1s-f">- {currenttotaltaxes}</p>
        <p id="sdi-tax5-2s-f">- {YTDtotaltaxes}</p>
        <p id="sdi-tax6s-f">Net Pay</p>
        <p id="sdi-tax6-1s-f">
          {" "}
          {parseFloat(
            parseInt(Global.form.currentAmount) - currenttotaltaxes
